...
minutes <- floor(var_seconds / 60)
seconds <- var_seconds %% 60

minutes_text <- if(minutes == 1) "1 minute" else paste(minutes, "minutes")
seconds_text <- if(seconds == 1) "1 second" else paste(seconds, "seconds")

paste0(var_seconds, " seconds is ", minutes_text, " and ", seconds_text, ".")
```
...
print(paste0(num, " squared is ", square_result, " and is the first number whose square exceeds ", threshold, "."))
```
